...
public class TicTacToe {
    ...
    public void playGame() {
        ...
        while (true) {
            ...
            if (checkWin('o')) {
                printTable();
                System.out.println("WON THE COMPUTER!");
                break;
            }
        }
    }
    ...
    public boolean checkWin(char symbol) {
        ...
        if (table[1][1] == symbol && table[2][2] == symbol && table[3][3] == symbol && table[4][4] == symbol)
            return true;
        if (table[0][4] == symbol && table[1][3] == symbol && table[2][2] == symbol && table[3][1] == symbol)
            return true;
        if (table[1][3] == symbol && table[2][2] == symbol && table[3][1] == symbol && table[4][0] == symbol)
            return true;
        ...
        if (table[1][0] == symbol && table[2][1] == symbol && table[3][2] == symbol && table[4][3] == symbol)
            return true;
        if (table[0][3] == symbol && table[1][2] == symbol && table[2][1] == symbol && table[3][0] == symbol)
            return true;
        if (table[1][4] == symbol && table[2][3] == symbol && table[3][2] == symbol && table[4][1] == symbol)
            return true;
